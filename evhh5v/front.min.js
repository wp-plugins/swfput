...
tv.setAttribute("preload",this.gotmetadata?"metadata":"none");while(this._vid.hasChildNodes()){var tn=this._vid.firstChild.cloneNode(true);tv.appendChild(tn);this._vid.removeChild(this._vid.firstChild);}

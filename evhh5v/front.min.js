...
btn.setAttribute("ontouchstart",hdlr);}else{btn.setAttribute("onclick","svg_click(this);");}
if(this.inibut_use_clearbg){var clss=false?"ico_transbg":"ico_clearbg";t=this.mk_circle(clss,"but_clearbg","50%","50%",r,doc);btn.appendChild(t);this.but_clearbg=t;}

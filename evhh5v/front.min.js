...
wd=Math.min(wd,vd.width);np=Math.round(Math.max((this.wdiv-wd)/2-0.5,0));wo=wd;ho=Math.round(wo/r);o.height=ho;o.width=wo;if(o.pixelHeight!==undefined){o.pixelHeight=ho;o.pixelWidth=wo;}
